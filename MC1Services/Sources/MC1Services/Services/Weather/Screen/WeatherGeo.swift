...
enum WeatherGeo {
  ...
  static func direction(from: MeshWXCoordinate, to: MeshWXCoordinate) -> MeshWXCompass {
    MeshWXCompass(degrees: bearingDegrees(from: from, to: to))
  }

  /// The initial great-circle bearing, 0 to 360, clockwise from north.
  static func bearingDegrees(from: MeshWXCoordinate, to: MeshWXCoordinate) -> Double {
