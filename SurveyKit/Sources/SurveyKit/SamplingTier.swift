...
public enum SamplingTier: String, CaseIterable, Sendable, Codable {
    /// ~115 m cells — walking, jogging, slow cycling.
    case fine
    /// ~300 m cells — cycling, city driving.
    case medium
    /// ~800 m cells — highway driving.
    case coarse

    public var resolution: Int {
        switch self {
        case .fine: SurveyGrid.baseResolution        // 10
        case .medium: SurveyGrid.baseResolution - 1  // 9
        case .coarse: SurveyGrid.baseResolution - 2  // 8
        }
    }
}
